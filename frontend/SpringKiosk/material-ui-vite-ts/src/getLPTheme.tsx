...
const getDesignTokens = (mode: PaletteMode) => ({
  palette: {
    ...
    divider: mode === 'dark' ? alpha(green[600], 0.3) : alpha(green[300], 0.5),
    background: {
      default: '#fff',
      paper: green[50],
      ...(mode === 'dark' && { default: green[900], paper: green[800] }),
    },
    text: {
      primary: green[800],
      green: green[600],
      ...(mode === 'dark' && { primary: '#fff', green: green[400] }),
    },
    action: {
    ...
    components: {
      ...
      MuiToggleButtonGroup: {
        styleOverrides: {
          root: ({ theme }) => ({
            borderRadius: '10px',
            boxShadow: `0 4px 16px ${alpha(green[400], 0.2)}`,
            '& .Mui-selected': {
              color: green[500],
            },
            ...(theme.palette.mode === 'dark' && {
              ...
              boxShadow: `0 4px 16px ${alpha(green[700], 0.5)}`,
            }),
          }),
        },
      },
          ...
          root: ({ theme, ownerState }) => ({
            ...
            ...(ownerState.variant === 'contained' &&
              ownerState.color === 'primary' && {
                ...
                backgroundImage: `linear-gradient(to bottom, ${green[400]}, ${green[600]})`,
                boxShadow: `inset 0 1px ${alpha(green[300], 0.4)}`,
                outline: `1px solid ${green[700]}`,
                '&:hover': {
                  background: green[400],
                  backgroundImage: 'none',
                  boxShadow: `0 0 0 1px  ${alpha(green[300], 0.5)}`,
                },
              }),
      ...
      MuiCard: {
        styleOverrides: {
          root: ({ theme, ownerState }) => ({
            ...
            borderRadius: 10,
            border: `1px solid ${alpha(green[200], 0.8)}`,
            boxShadow: 'none',
            transition: 'background-color, border, 80ms ease',
            ...(ownerState.variant === 'outlined' && {
              background: `linear-gradient(to bottom, #FFF, ${green[50]})`,
              '&:hover': {
                borderColor: green[300],
                boxShadow: `0 0 24px ${green[100]}`,
              },
            }),
            ...(theme.palette.mode === 'dark' && {
              backgroundColor: alpha(green[800], 0.6),
              border: `1px solid ${alpha(green[700], 0.3)}`,
              ...(ownerState.variant === 'outlined' && {
                background: `linear-gradient(to bottom, ${green[900]}, ${alpha(
                  green[800],
                  0.5,
                )})`,
                '&:hover': {
            ...
            ...(theme.palette.mode === 'dark' && {
              '& .MuiOutlinedInput-root': {
                ...
                '& fieldset': {
                  ...
                  background: `${alpha(green[800], 0.4)}`,
                },
                '&:hover': {
                  borderColor: green[300],
                },
                '&.Mui-focused': {
                  borderColor: green[400],
                  outline: '4px solid',
                  outlineColor: alpha(green[500], 0.5),
                },
              },
            }),
          }),
