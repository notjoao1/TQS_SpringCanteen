...
class MenuControllerTest {
  ...
  @MockBean private IMenuService menuService;
  ...
  void givenListOfMenus_whenGetAllMenus_returnsMenusWithAllInformation() {
    when(menuService.getAvailableMenus())
        .thenReturn(Arrays.asList(mapper.toDTO(menu1), mapper.toDTO(menu2)));
    ...
    RestAssuredMockMvc.given()
        ...
        .body(
            "[0].mainDishOptions.mainDishIngredients.quantity",
            notNullValue()); // check if ingredients was loaded
  }
}
