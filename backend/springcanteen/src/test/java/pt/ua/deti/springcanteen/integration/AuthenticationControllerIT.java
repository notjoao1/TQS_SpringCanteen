...
class AuthenticationControllerIT {
  ...
  void givenInvalidCredentials_whenCreateEmployee_thenReturn403() {
    ...
    employeeRepository.save(
        new Employee("testname", "testemail1@gmail.com", "testpassword", EmployeeRole.COOK));
  ...
  void givenValidCredentials_whenLogin_thenReturnEmployeeAndToken() {
    ...
    given().contentType(ContentType.JSON).body(signUpRequest).when().post("api/auth/signup");

    String signInRequest =
        "{" + "    \"email\": \"testemail2@gmail.com\"," + "    \"password\": \"testpassword\"}";
  ...
  void givenInvalidEmail_whenLogin_thenReturn403() {
    ...
    String signInRequest =
        "{" + "    \"email\": \"no_one@gmail.com\"," + "    \"password\": \"1234\"}";
  ...
  void givenValidEmailWrongPassword_whenLogin_thenReturn403() {
    ...
    String signInRequest =
        "{" + "    \"email\": \"testemail3@gmail.com\"," + "    \"password\": \"wrongpassword\"}";
